...
-(BOOL)isCocoaWgetWgetrc
{
    ...
    NSString *str=[NSString stringWithContentsOfFile:[NSString stringWithFormat:@"%@/.wgetrc",NSHomeDirectory()]];
...
-(void)backupWgetrc
{
    ...
    if (([manager fileExistsAtPath:filePath])&&([self isCocoaWgetWgetrc]==NO)){
        [manager removeFileAtPath:backupPath handler:self];
        [manager copyPath:filePath toPath:backupPath handler:self];
    }
    NSLOG(@"backupWgetrc");
}
...
-(void)restoreWgetrc
{
    ...
    if ([manager fileExistsAtPath:backupPath]){
        [manager removeFileAtPath:filePath handler:self];
        [manager copyPath:backupPath toPath:filePath handler:self];
    }
    NSLOG(@"restoreWgetrc");
}
